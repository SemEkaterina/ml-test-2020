window.addEventListener('load', function () {
    ...
    function callWebService() {
        ...
        jQuery.ajax({
            url: "https://odr-test-2020.azure-api.net/word/execute?api-version=2.0&details=true",
            beforeSend: function (xhrObj) {
                xhrObj.setRequestHeader("Content-Type", "application/json;charset=utf-8");
                xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key", "9121c10cb41241e593ff1d2c7333ddfa");
